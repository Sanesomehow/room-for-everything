    ...
    <div className="max-w-screen">
      <nav className="flex flex-col lg:flex-row items-center pb-10 px-2 md:px-10 relative">
        <div className="flex items-center justify-between h-18 w-full lg:w-auto px-5 lg:px-0">
          ...
          <div id="create-btn" className="flex justify-center gap-5 lg:hidden">
            <button
              type="button"
            ...
            {isAuthenticated && (
              <button
                onClick={logout}
                className="bg-[#15202B] flex items-center gap-2 px-4 py-3 text-red-300 hover:text-red-600 font-medium rounded-full hover:scale-110 hover:border-red-600 transition-all duration-450"
              >
                <svg
