export function NotFound() {
    return(
        <div className="m-0 p-0 bg-[#0a1821] w-auto h-149 text-white text-center font-[Roboto,Arial,sans-serif]">
            <div className="fixed right-70 bottom-50 text-white text-right">
                <svg aria-labelledby="404" className="not-found w-[560px] h-[225px] -mr-[10px]">
                ...
                <h1 className="font-bold text-[40px]">page not found</h1>
            </div>

            <svg aria-labelledby="Starry sky" className="starry-sky block w-full h-full object-cover">
                <title id="svgtitle2">Starry sky</title>
                <g className="all-stars animate-pulse" fill="#F6F5BC">
