...
export function Login() {
  ...
  return (
    <div className="min-h-screen flex justify-center px-4 pt-20 pb-8">
      <form
      ...
      >
        <h3 className="text-center text-xl font-semibold text-blue-500 pb-5">Log In</h3>
        <div className="grid gap-4 sm:gap-5">
          ...
          <Button className="w-full mt-3 sm:mt-5 bg-blue-600 hover:bg-indigo-400 shadow-lg">
            Log In
          </Button>
        </div>
